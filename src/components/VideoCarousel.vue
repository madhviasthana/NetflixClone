<template>
  ...
  <!-- Movie content -->
    ...
    @update:modelValue="updateSlideValue"
        ...
        >
        <Slide v-for="(slide, index) in movies" :key="slide.name" class="flex items-center object-cover text-white bg-transparent">
...
.active {
  border: 4px solid white;  /* Ensure this visually highlights the selected movie */
}
